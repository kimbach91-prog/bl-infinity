#!/usr/bin/env python3
"""R312: p0-p4-only exact-frame LOTO sweep replacing the cancelled heavy R302 routes.
...
def main():
    ...
    out={
      "schema":"deus/arc3-r312-first4-exactframe-loto/1",
      "rung":RUNG,"game":a.game,
      "lineage":{"r302_run":35826527904,"r302_status":"cancelled heavy local/phase/causal-delta route; R312 is a distinct lightweight exact-frame lens fallback"},
      "protocol":{
      ...
      "truth":{
        ...
        "competition_submission":False,"submission_quota_spent_by_r312":False
      }
    }
