...
required = [
    ...
    ROOT / "public/novel/index.html",
    ROOT / "content/novel/00_CANON_LAW.md",
    ROOT / "content/novel/01_CHAPTER_001.md",
    ROOT / "machine/novel-canon.json",
    ROOT / "scripts/stage_novel.py",
