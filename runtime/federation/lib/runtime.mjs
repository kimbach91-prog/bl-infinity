...
export function createFederationRuntime({ providers = [], localHandlers = {}, manifestVerifier = null, audit = null, budgetConfig = {}, state = null, allowedStateDataClasses = null } = {}) {
  ...
  const orchestrator = new FederationOrchestrator({ registry, executor, audit: effectiveAudit, queue: state?.queue, cache: state?.cache, ledger: state?.ledger, budget: state?.budget ?? new BudgetGovernor(budgetConfig), allowedStateDataClasses });
