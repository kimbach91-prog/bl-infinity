...
const plan=compileInternetFabricPlan({
  ...
  operators:[
    {id:'name',operatorAbi:{id:'net.dns.resolve',inputType:'dns.question',outputType:'dns.answer',protocols:['DNS'],receiptSchema:'deus-public-functional-receipt/1'},logicalWorkUnits:'100000000000',requireReceipt:true,maxEvidenceAgeMs:86400000},
    {id:'time',operatorAbi:{id:'net.time.sync',inputType:'ntp.request',outputType:'ntp.reply',protocols:['NTP'],receiptSchema:'deus-public-functional-receipt/1'},logicalWorkUnits:'1000000000',requireReceipt:true,maxEvidenceAgeMs:86400000},
    {id:'compute',operatorAbi:{id:'compute.general',inputType:'job',outputType:'result',receiptSchema:'executor-result/1'},deps:['name','time'],logicalWorkUnits:'1000000',maxRoutes:4,requireReceipt:true,maxEvidenceAgeMs:3600000},
    {id:'commit',operatorAbi:{id:'state.store',inputType:'workspace.object',outputType:'workspace.revision',receiptSchema:'workspace-revision/1'},deps:['compute'],dataClass:'BL-S1',logicalWorkUnits:'1',requireReceipt:true,maxEvidenceAgeMs:3600000},
  ],
